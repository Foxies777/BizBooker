...
// Effects
export const fetchServicesFx = createEffect<string, Service[]>(
    getAvailableServices
);
export const fetchSpecialistsFx = createEffect<
    { serviceId: string; businessId: string },
    Specialist[]
>(({ serviceId, businessId }) =>
    getSpecialistsByService(serviceId, businessId)
);

export const fetchAvailableDatesFx = createEffect<
...
export const createBookingFx = createEffect<BookingRequest, BookingResponse>(
    createBooking
);

// Stores
export const $services = restore<Service[]>(fetchServicesFx.doneData, []);
export const $specialists = restore<Specialist[]>(
    fetchSpecialistsFx.doneData,
    []
);
