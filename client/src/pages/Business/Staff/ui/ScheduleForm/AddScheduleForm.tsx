...
const AddScheduleForm: React.FC<AddScheduleFormProps> = ({
    ...
    const [workTime, setWorkTime] = useState<{
        ...
        endTime: dayjs().hour(22).minute(0),
    });
    const {
        schedules,
        fetchStaffSchedules,
    ...
    const onFinish = async (values: any) => {
        ...
        const commonScheduleData = {
            scheduleType: scheduleType as
                ...
                | "recurring",
            workHours: {
                startTime: workTime.startTime.format("HH:mm"),
        ...
        if (scheduleType === "recurring") {
            ...
            try {
                await Promise.all(
                    requests.map((req) => handleCreateSchedule(req))
                );
    ...
    const handleScheduleTypeChange = (
        type: "temporary" | "permanent" | "recurring"
    ) => {
    ...
    return (
        ...
        >
            ...
            <Form form={form} layout="vertical" onFinish={onFinish}>
                ...
                <Form.Item name="daysOff" label="Выходные дни">
